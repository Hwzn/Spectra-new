...
class BuildWorkingDays extends StatelessWidget {
  final WorkingTimesData workingTimesData;
  const BuildWorkingDays({Key? key, required this.workingTimesData}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<GenericBloc<List<AvailableDayModel>>,
        GenericState<List<AvailableDayModel>>>(
      bloc: workingTimesData.daysBloc,
      builder: (_, state) {
                        ...
                        child: ListView(
                          ...
                          children: List.generate(
                            state.data.length,
                                (index) => InkWell(
                              onTap: () =>
                                  workingTimesData.selectDay(index),
                              child: Container(
